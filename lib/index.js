...
class Cropper extends React.Component {
  ...
  mouseMoveListener (e) {
    ...
    this.setState({
      ...
      if (this.props.onCropData) {
        this.props.onCropData(this.state.image);
      }
    });
  }
  ...
  handleCrop () {
    ...
    this.props.onCrop(data, this.state.image);
  }
  ...
  render () {
    const cropperOnly = this.props.cropperOnly;
...
Cropper.propTypes = {
    ...
    zoom: numberableType,
    cropperOnly: React.PropTypes.bool,
    onCropData: React.PropTypes.func
};
Cropper.defaultProps = { width: 400, height: 400, zoom: 1, cropperOnly: false };
    ...
    if (this.props.cropperOnly) {
      content = (
        <Cropper
          ...
          cropperOnly={this.props.cropperOnly}
          onCropData={this.props.onCropData}
        />
      );
    } else {
      content = (
        <Modal
          ...
          backdrop={false}
          bsClass={this.props.customClass}
          >
...
AvatarCropper.defaultProps = { width: 400, height: 400, modalSize: "large",
                               closeButtonCopy: "Close", cropButtonCopy: "Crop and Save", cropperOnly: false, customClass: ''};
